                ...
                <div className="flex items-center w-full">
                    <div className="mb-8 w-full">
                        <h1 className="text-4xl font-bold leading-snug tracking-tight text-sky-500 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight">
                            HackMUN VII Conference Details
                        </h1>
                        ...
                        <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl">
                            Given the in-person nature of HackMUN VII, we will be charging $25 per delegate as a registration fee. An online payment portal will be sent out to schools/individuals registered for the conference.
                        </p>
                        ...
                        <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl">
                            HackMUN does not provide transportations nor cover costs for transportation. If you face financial difficulties traveling to Hackley, please email the secretariat at esuttiratana@students.hackleyschool.org and biaderosa@students.hackleyschool.org and we will try to help you work out a solution.
                        </p>
